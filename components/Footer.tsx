...
export default function Footer() {
  ...
  return (
    <footer id="contacts" className="bg-[#032a62] py-[45px]">
      <div className="container mx-auto px-4">
        {/* Заголовок секции */}
        <div className="text-center mb-[40px] md:mb-[90px]">
          <h2 className="text-[30px] text-white mb-4">Контакты</h2>
          <div className="text-[20px] text-white max-w-[560px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="md:pl-[8.33%]">
            <div className="text-[20px] text-white space-y-6">
              <div>
            ...
            <div className="mt-6 flex gap-2">
              <a
                ...
                className="w-[30px] h-[30px] bg-white rounded-full flex items-center justify-center hover:opacity-80"
              >
                <svg className="w-5 h-5" viewBox="0 0 100 100" fill="#032a62">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <input
                  ...
                  placeholder="Имя"
                  required
                  className="w-full px-4 py-2 rounded-[5px] border border-[#c7c7c7]"
              ...
              <button
                type="submit"
                className="w-full px-6 py-2 bg-white text-[#032a62] rounded-[5px] hover:bg-gray-100 transition-colors"
              >
                Отправить
              </button>
            </form>

...
export default function Settings() {
  ...
  return (
    ...
    >
      <div className="bg-white overflow-hidden [background:linear-gradient(180deg,#f9fdfc_0%,#ffffff_100%)] w-[414px] h-[2555px] relative">
        <div className="px-4 w-full">
          ...
          >
            <div className="p-0 h-full relative">
              <img
                ...
                alt="Китайский: полный курс"
                src="/assets/Chine_1.svg"
              />
          ...
          >
            <div className="p-0 h-full relative">
              <img
                className="absolute w-[89px] h-[103px] top-5 left-5"
                alt="Китайский для путешествий"
                src="/assets/Chine_2.svg"
              />
              <div className="absolute w-6 h-6 top-5 left-[134px] rounded-[32.91px] overflow-hidden">
                <img
                  className="w-full h-full"
          ...
          >
            <div className="p-0 h-full relative">
              <img
                className="absolute w-[89px] h-[103px] top-5 left-5"
                alt="Китайские иероглифы"
                src="/assets/Chine_3.svg"
              />
              <div className="absolute w-6 h-6 top-5 left-[134px] rounded-[32.91px] overflow-hidden">
                <img
                  className="w-full h-full"
          ...
          <div className="absolute w-[68px] h-[68px] top-[1090px] left-[25px] rounded-[93.26px] overflow-hidden">
            <img className="w-full h-full" alt="China flag" src="/assets/Chine_0.svg" />
          </div>

          <h2 className="absolute w-[275px] top-[1073px] left-[119px] font-['Inter',Helvetica] font-bold text-[#47b6f2] text-3xl">
            Онлайн занятия с преподавателем: китайский
          </h2>

          {/* Карточка бизнес-китайского */}
          <div className="border text-card-foreground shadow absolute w-[374px] h-[247px] left-5 bg-white rounded-[10px] overflow-hidden"
            style={{ top: "1180px" }}>
            <div className="p-0 h-full relative">
              <img className="absolute w-24 h-[184px] top-[13px] left-5" alt="Бизнес-китайский" src="/assets/Chine_5.svg" />
              <div className="absolute w-6 h-6 top-5 left-[129px] rounded-[32.91px] overflow-hidden">
                <img className="w-full h-full" alt="China flag" src="/assets/Chine_Small.svg" />
              </div>
          ...
          <div className="border text-card-foreground shadow absolute w-[374px] h-[247px] left-5 bg-white rounded-[10px] overflow-hidden"
            style={{ top: "1457px" }}>
            <div className="p-0 h-full relative">
              <img className="absolute w-24 h-[184px] top-[13px] left-5" alt="Для подготовки к экзаменам" src="/assets/Chine_6.svg" />
              <div className="absolute w-6 h-6 top-5 left-[129px] rounded-[32.91px] overflow-hidden">
                <img className="w-full h-full" alt="China flag" src="/assets/Chine_Small.svg" />
              </div>
              <div className="absolute top-[22px] left-[194px] font-['Inter',Helvetica] font-medium text-[#dcdcdc] text-sm">
          ...
          {/* Карточка китайского для переезда и жизни */}
          <div className="border text-card-foreground shadow absolute w-[374px] h-[247px] left-5 bg-white rounded-[10px] overflow-hidden"
            style={{ top: "1734px" }}>
            <div className="p-0 h-full relative">
              <img className="absolute w-24 h-[184px] top-[13px] left-5" alt="Китайский для переезда и жизни" src="/assets/Chine_7.svg" />
              <div className="absolute w-6 h-6 top-5 left-[129px] rounded-[32.91px] overflow-hidden">
                <img className="w-full h-full" alt="China flag" src="/assets/Chine_Small.svg" />
              </div>
              <div className="absolute top-[22px] left-[194px] font-['Inter',Helvetica] font-medium text-[#dcdcdc] text-sm">
          ...
          {/* Карточка китайского для путешествий (преподаватель) */}
          <div className="border text-card-foreground shadow absolute w-[374px] h-[247px] left-5 bg-white rounded-[10px] overflow-hidden"
            style={{ top: "2011px" }}>
            <div className="p-0 h-full relative">
              <img className="absolute w-24 h-[184px] top-[13px] left-5" alt="Китайский для путешествий" src="/assets/Chine_8.svg" />
              <div className="absolute w-6 h-6 top-5 left-[129px] rounded-[32.91px] overflow-hidden">
                <img className="w-full h-full" alt="China flag" src="/assets/Chine_Small.svg" />
              </div>
              <div className="absolute top-[22px] left-[194px] font-['Inter',Helvetica] font-medium text-[#dcdcdc] text-sm">
          ...
          {/* Карточка китайского для детей */}
          <div className="border text-card-foreground shadow absolute w-[374px] h-[247px] left-5 bg-white rounded-[10px] overflow-hidden"
            style={{ top: "2288px" }}>
            <div className="p-0 h-full relative">
              <img className="absolute w-24 h-[184px] top-[13px] left-5" alt="Китайский для детей" src="/assets/Chine_9.svg" />
              <div className="absolute w-6 h-6 top-5 left-[129px] rounded-[32.91px] overflow-hidden">
                <img className="w-full h-full" alt="China flag" src="/assets/Chine_Small.svg" />
              </div>
              <div className="absolute top-[22px] left-[194px] font-['Inter',Helvetica] font-medium text-[#dcdcdc] text-sm">
